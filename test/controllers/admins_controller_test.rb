...
class AdminsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create admin" do
    assert_difference('Admin.count') do
      post admins_url, params: { admin: { password: 'secret', password_confirmation: 'secret' } }
    end
  ...
  test "should update admin" do
    patch admin_url(@admin), params: { admin: { password: 'secret', password_confirmation: 'secret' } }
